...
public class GitHubProjectTest {
    ...
    String sshKey = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAINAnIPRrQBLdT+wlC1avWoleda5pckrSAKAJwYJRscO8";
    int sshKeyId;
    //Request Specification
    RequestSpecification requestSpec = new RequestSpecBuilder().
            setBaseUri("https://api.github.com/user/keys").addHeader("Authorization", "token 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").
